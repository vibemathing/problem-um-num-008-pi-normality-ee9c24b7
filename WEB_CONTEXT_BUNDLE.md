...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-num-008-pi-normality-ee9c24b7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NUM-008"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-num-008-pi-normality-ee9c24b7-v1",
      "problem_contract_sha256": "2461e5a068823ab9c414f553a96077de3b65c6dc43c52095e988978dd8b5b05e",
      "problem_id": "problem:um-num-008-pi-normality-ee9c24b7",
      "route_id": "route:um-num-008-pi-normality-ee9c24b7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-num-008-pi-normality-ee9c24b7-source-fidelity-01",
      "graph_id": "graph:um-num-008-pi-normality-ee9c24b7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-num-008-pi-normality-ee9c24b7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-num-008-pi-normality-ee9c24b7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is π a normal number (all digits equally frequent in all bases)?"
          },
          "statement_sha256": "2040824e5ac033b173c06ed0197cf6808c0cd49c32ad71eae0300174d74e1d70"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-num-008-pi-normality-ee9c24b7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-num-008-pi-normality-ee9c24b7-root",
      "route_id": "route:um-num-008-pi-normality-ee9c24b7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-num-008-6097b78c080a",
        "url": "https://www.unsolvedmath.com/problems/NUM-008"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
